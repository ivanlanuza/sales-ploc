  ...
  return (
    <div className="relative bg-white overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mb-8">
                  <span className="block pb-8 mb-8 xl:inline">
                    Sales Automation for
                  </span>{" "}
                  <p className="block mt-16 text-indigo-600 xl:inline">
                    iRipple Group
                  </p>
                </h1>
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md shadow">
                    <button
                      onClick={() =>
                        signIn("google", {
                          callbackUrl: "/interaction/create",
                        })
                      }
      ...
      <div className="block lg:hidden">
        <h1 className="text-xl tracking-tight font-extrabold text-center mt-32 text-gray-900 sm:text-5xl md:text-6xl mb-8">
          <span className="pb-2 mb-8">Sales Automation for iRipple Group</span>
        </h1>
        <div className="z-0 mt-2 sm:mt-8 pb-16 sm:flex sm:justify-center lg:justify-start px-8">
          <div className="rounded-md shadow">
            <button
              onClick={() =>
                signIn("google", {
